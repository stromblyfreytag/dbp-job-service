...
public class LightArcTokenSetMember implements ArcTokenSetMember {
    protected LightTokenSet tokenSet;
    protected LightArcToken token;
    protected int memberIndex;

    public LightArcTokenSetMember(LightTokenSet tokenSet,
            LightArcToken token,
            int memberIndex) {
    ...
    public boolean equals(Object obj) {
        ...
        LightArcTokenSetMember other = (LightArcTokenSetMember) obj;
